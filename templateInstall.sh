...
# ╔═════════════════════════════════════════════════════════════════════════════════════╗
# ║ Возвращаемые значения функции  arg_processing()                                     ║
# ╠═════════════╦═══════════════════════════════════════════════════════════════════════╣
# ║     0       ║ Зарезервировано                                                       ║
# ╠═════════════╬═══════════════════════════════════════════════════════════════════════╣
# ║     1       ║ Получен ключ name, ожидается значение                                 ║
# ╠═════════════╬═══════════════════════════════════════════════════════════════════════╣
# ║     2       ║ значение name присвоено, ожидается следующий ключ                     ║
# ╠═════════════╬═══════════════════════════════════════════════════════════════════════╣
# ║     3       ║ Значение name не соответствует ожиданию && вывод ошибки:exit 2        ║
# ╠═════════════╬═══════════════════════════════════════════════════════════════════════╣
# ║     4       ║ Получен ключ link, ожидается значение                                 ║
# ╠═════════════╬═══════════════════════════════════════════════════════════════════════╣
# ║     5       ║ значение link присвоено, ожидается следующий ключ                     ║
# ╠═════════════╬═══════════════════════════════════════════════════════════════════════╣
# ║     6       ║ Значение link не соответствует ожиданию && вывод ошибки:exit 2        ║
# ╠═════════════╬═══════════════════════════════════════════════════════════════════════╣
# ║    128      ║ получен ключ calatog, вызывается функция getCatalog && exit 0         ║
# ╠═════════════╬═══════════════════════════════════════════════════════════════════════╣
# ║    129      ║ получен ключ help, вызывается функция helpFlag && exit 0              ║
# ╚═════════════╩═══════════════════════════════════════════════════════════════════════╝
...
arg_processing(){
    #echo "arg2 = $2"
    if [[ "$1" =~ ^[\-]{2}([A-Za-z]+)$ || "$1" =~ ^[\-]([A-Za-z])$ ]];
        then
            temp_arg="${BASH_REMATCH[1]}"
            case "$temp_arg" in
                n|name)
                    if [[ "$2" != "NULL" ]]; then
                        valueChech $temp_arg $2
                        if [[ "$?" == 0 ]]; then
                            name=$2
                            echo -e "name = $name"
                            return 1
